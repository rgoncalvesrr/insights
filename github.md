A versão original deste artigo está no [TabNews](https://www.tabnews.com.br/guscsales/uma-maneira-de-organizar-suas-branches-commits-e-pull-requests) e foi escritva por Gustavo Sales. Essa transcrição tem objetivo de fazer uma backup deste arquivo.
...
_**Eu sei, nem sempre vai dar pra seguir certinho, mas é bom ter um alvo né?**_
